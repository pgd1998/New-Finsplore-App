...
class AccountRegisterApi extends BaseApi<Account> {
  AccountRegisterApi() : super(Account.fromJson, prefix: "/api/auth/register", useAuth: false);
  ...
  Future<bool> registerLegacy(String email, String password, String username, String phoneNumber) {
